...
class BlogTest extends TestCase {
	...
	function testFromJson(): void {
		...
		$blog = Blog::fromJson((object) [
			"blog" => "https://bitbucket.org/cedx/akismet.php",
			"blog_charset" => "UTF-8",
			"blog_lang" => "en, fr"
		]);
		...
		assertThat((string) $blog->getUrl(), equalTo("https://bitbucket.org/cedx/akismet.php"));
	}

	/** @testdox ->jsonSerialize() */
	function testJsonSerialize(): void {
		// It should return only the blog URL with a newly created instance.
		$data = (new Blog(new Uri("https://bitbucket.org/cedx/akismet.php")))->jsonSerialize();
		assertThat(get_object_vars($data), countOf(1));
		assertThat($data->blog, equalTo("https://bitbucket.org/cedx/akismet.php"));
